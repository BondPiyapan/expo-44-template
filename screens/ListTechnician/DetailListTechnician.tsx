...
export default function DetailListTechnician({ route: { params } }) {
      ...
      >
        {_map(dataListAll, (v: ICustomer, index) => (
          <TouchableOpacity
            onPress={() =>
              navigation.navigate(
                "CheckListDetailTechnician" as never,
                { key: params.key, id: index } as never
              )
            }
            style={{
              padding: 16,
          ...
          >
            ...
            >
              {v.tempImageRepair ? "แก้ไขเรียบร้อย" : "รอการแก้ไข"}
            </Text>
          </TouchableOpacity>
        ))}
      </ScrollView>
